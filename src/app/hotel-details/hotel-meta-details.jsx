  ...
  return (
    <>
      <section className="space-y-4">
        ...
        <div className="text-orange-500 bg-orange-50 flex items-center gap-1 p-2 border rounded-sm">
          <Icon icon="heart" size="16" />
          <p className="text-sm font-medium">
            Located Less Than 5 Kms From Medanta Hospital | Located 3 Kms From
