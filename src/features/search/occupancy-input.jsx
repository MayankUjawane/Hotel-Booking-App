  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <div className="px-4 py-2 h-full rounded bg-background border-border min-w-60 flex-auto flex items-center justify-between">
                ...
                <FormControl>
                  <div className='border rounded border-foreground/50 flex items-center'>
                    <Button
                      ...
                      onClick={(e) => {
                        e.preventDefault();
                        field.onChange((field.value > 0) ? field.value - 1 : field.value);
                      }}
                    >
                      <Icon icon="minus" />
                    </Button>
